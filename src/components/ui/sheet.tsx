  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        style={{ backgroundColor: "var(--color-surface-background)", color: "var(--color-text-primary)", ...style }}
        {...props}
      >
        {children}
        {showCloseButton && (
...
function SheetTitle({ className, style, ...props }: SheetPrimitive.Title.Props) {
  return (
